...
//require_once( $mosConfig_absolute_path.'/administrator/components/com_jcalpro/themes/themes.html.php' );
//require_once( $mosConfig_absolute_path.'/administrator/components/com_jcalpro/themes/themes.class.php' );
    ...
    */
    function editThemes( $option, $uid, $client ) {
        ...
        if ($uid) {
            ...
            // XML library
            require_once( JPATH_BASE . DS .'includes'.DS.'domit'.DS.'xml_domit_lite_include.php' );
            // xml file for module
            $xmlfile = JPATH_BASE . DS .'plugins'.DS.'editors'.DS.'extcal'.DS.'jscripts'.DS.'tiny_mce'.DS.'themes'. DS .$row->theme . DS . $row->theme .'.xml';
            ...
            $folders = mosReadDirectory( JPATH_BASE . DS .'plugins'.DS.'editors'.DS.'extcal'.DS.'jscripts'.DS.'tiny_mce'.DS.'themes'.DS );
            $folders2 = array();
            foreach ($folders as $folder) {
                if (is_dir( JPATH_BASE . DS . 'plugins'.DS.'editors'.DS.'extcal'.DS.'jscripts'.DS.'tiny_mce'.DS.'themes' . DS . $folder ) && ( $folder <> 'CVS' ) ) {
