 ...
 *
 * @version     $Id: README_de.php 959 2008-02-16 10:54:50Z geraint $
 * @package     Events
...
include_once(JPATH_ADMINISTRATOR."/components/com_events/lib/version.php");
...
<div class="text">
	<ul>
		<li>Version <?php echo $version->getShortVersion();?> - <a href="http://developer.joomla.org/sf/projects/jevents" target="_blank" title="Projektseite">Projektseite</a></li>
		<li><?php echo $version->getLongCopyright();?></li>
		<li>Copyright (C) 2000 - 2003 Eric Lamette, Dave McDonnell</li>
		<li>Voraussetzung: <a href="http://developer.joomla.org" target="_blank" title="Joomla">Joomla</a> 1.x</li>
		<li>Lizenz: GNU/GPL <a href="http://www.gnu.org/copyleft/gpl.html" target="_blank" title="Lizenz">Lizenz</a></li>
		<li>Webseite: <a href="http://developer.joomla.org/sf/projects/jevents" target="_blank" title="JEvents">JEvents</a></li>
    ...
    <div>
		...
		Arthur van der Molen, Thomas Nilsson, sakara, Markku Suominen, Martin Welen, David A. Quirantes García,
		Pedro López Peñalosa, Geraint Edwards, Thomas Stahl, mic und viele andere .....
	</div>
    <hr />
	<div>
