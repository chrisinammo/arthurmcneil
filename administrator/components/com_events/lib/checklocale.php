 ...
 *
 * @version     $Id: checklocale.php 912 2007-12-21 11:19:31Z geraint $
 * @package     Events
...
function checkLocale(){
	...
	HTML_events_admin::_footer("checkLocale",$option);
	
	echo "<div align='left'><h2>Simple locale testing routines</h2>";	
		
	$currentLocale = setlocale(LC_TIME, 0);
	echo "Your current system locale is :  $currentLocale<br/>";
	echo "Joomla has set your locale as :  $currentLocale<br/><hr/>";
	...
	<form action="index2.php" method="get" style="font-size:1;">
    	...
    	<table cellpadding="4" cellspacing="4" border="0"  style='background-color:#cccccc;text-align:left'>
      		<tr>
      			<td >
