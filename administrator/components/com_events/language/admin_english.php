 ...
 *
 * @version     $Id: admin_english.php 916 2008-01-03 13:43:27Z geraint $
 * @package     Events
...
define( '_CAL_LANG_HIDE_LINKS',			'Hide Links using Javascript' );
define( '_CAL_LANG_HIDE_LINKS_TIP',		'Make links inaccessible to most search engines' );
...
define( '_CAL_LANG_VIEWNAME',		    'Choose layout view' );
define( '_CAL_LANG_TIP_VIEWNAME',	    'Choose layout view' );
define( '_CAL_LANG_VIEW_DEFAULT',	    'Default View' );
define( '_CAL_LANG_VIEW_ALTERNATIVE',	'Alternative View' );
define( '_CAL_LANG_EARLIEST_YEAR',		'First Year to Display in Calendar' ); // 1.5
define( '_CAL_LANG_LATEST_YEAR',		'Last Year to Display in Calendar' ); // 1.5
define( '_CAL_STOP_ROBOTS',				'Set meta-tag to stop robots crawling (Joomla 1.5 only)');

// RSS config
define( '_CAL_LANG_TAB_RSS',			'RSS' );
define( '_CAL_LANG_SETT_FOR_RSS',		'These settings are only the RSS syndications' );
define( '_CAL_RSS_CACHE',				'Should RSS results be cached?' );
define( '_CAL_RSS_LIMIT',				'Number of Events to show' );
define( '_CAL_RSS_TITLE',				'RSS Title' );
...
define( '_CAL_RSS_LIMIT_TEXT_LENGTH',	'Limit Text Length' );
...
define( '_CAL_LANG_TIP_LEV_HIDE_LINK',		'Make links inaccessible to most search engines');
define( '_CAL_LANG_TIP_MAX_DISPLAY',		'Amount of maximal displayed events <strong>as text</strong> per day in month view<br />If you have many events per day, displaying them could distroying your layout.<br />Define here how many events should displayed as text, if too many they will be displayed as an icon (tooltip is not affected)<br /><strong>Tip</strong>: Setting the value to 0 [null] force the display for all events as icon' );
define( '_CAL_LANG_TIP_DIS_STARTTIME',		'Should the starttime displayed [ month view ]' );
	// tooltips
define( '_CAL_LANG_ENABLETOOLTIP_TIP',		'Should tooltips be shown for main monthly event calendar');
define( '_CAL_LANG_ENABLETOOLTIP',			'Enable Calendar popup tooltips');
...
define( '_CAL_LANG_LEV_MAX_DISPLAY_TIP','Maximum number of events to display in the module(max 150)' );
...
define( '_CAL_LANG_LEV_REP_EV_ONCE_TIP','Display any event which has a repeat type only once in the module' );
define( '_CAL_LANG_LEV_EV_AS_LINK',		'Display Events As Link' );
define( '_CAL_LANG_LEV_EV_AS_LINK_TIP',	'Display event titles as links to the "view_detail" '.$option.' task which will display details of the event' );
define( '_CAL_LANG_LEV_DISPLAY_YEAR',	'Display Year' );
define( '_CAL_LANG_LEV_CSS_DATE_FIELD',	'Disable default CSS Date Field Style' );
define( '_CAL_LANG_LEV_CSS_DATE_FIELD_TIP',	'Do not apply the default mod_events_latest_date css class to the date field' );
define( '_CAL_LANG_LEV_CSS_TITLE_FIELD','Disable default CSS Title Field Style' );
define( '_CAL_LANG_LEV_CSS_TITLE_FIELD_TIP','Do not apply the default mod_events_latest_content css class to the title field' );
define( '_CAL_LANG_LEV_LINKCAL_FIELD',	'Display link to the Calendar Component');
define( '_CAL_LANG_LEV_LINKCAL_FIELD_TIP', 'Generates a link to the Calendar Component. Current category restrictions are passed as parameters');
define( '_CAL_LANG_LEV_NOLINK',			'No link');
define( '_CAL_LANG_LEV_FIRSTLINE',		'First line');
define( '_CAL_LANG_LEV_LASTLINE',		'Last line');

define( '_CAL_LANG_LEV_HIDE_LINK',		'Hide Title Links using Javascript');
define( '_CAL_LANG_LEV_CUST_FORM_STRING','Custom Format String' );
define( '_CAL_LANG_LEV_CUST_FORM_STRING_TIP','Allows a customized specification of the desired event fields and format to be used to display the event in the module.  The string can specify html directly.' );
define( '_CAL_LANG_LEV_AVAIL_FIELDS',	'Available Event fields');
define( '_CAL_LANG_LEV_FUNC_DATE',		'Date format with date()');
define( '_CAL_LANG_LEV_FUNC_STRFTIME',	'Date format with strftime()');
...
// Administration 
define( '_CAL_LANG_ADMIN_STATUS',		'Status' );
define( '_CAL_LANG_ADMIN_COMPONENT_STATE', 'Component Status Report');
define( '_CAL_LANG_ADMIN_SEARCH_BOT_STATE' , 'Search mambot');
define( '_CAL_LANG_ADMIN_CPANEL',			'CPanel');
define( '_CAL_LANG_ADMIN_COPY',				'Copy');
define( '_CAL_LANG_ADMIN_COPYEDIT',			'Copy+Edit');
define( '_CAL_LANG_ADMIN_REFRESH',			'Update');
// installation/Administration
define( '_CAL_LANG_INSTAL_MAIN',		'JEvents' );
...
define( '_CAL_CHECK_LOCALE',			'Check Locale configuration'); // 1.5
define( '_CAL_LANG_ADMIN_LEGACY',		'Legacy Functions - no longer supported from version 1.6 please migrate');//1.5
define( '_CAL_CATEGORY_TITLE',			'Title'); //1.5
define( '_CAL_CATEGORY_PARENT',			'Parent'); //1.5
define( '_CAL_CATEGORY_PARENT_NONE',			'No Parent'); //1.5
define( '_CAL_LANG_ADMIN_CATSUPDATED',			'Categories Updated'); //1.5

// Ical Stuff
define( '_CAL_LANG_ICAL_SUMMARY',		'iCal event summary');
define( '_CAL_LANG_ADMIN_ICAL_EVENTS',		'Manage<br/>iCAL Events');
define( '_CAL_LANG_ADMIN_ICAL_SUBSCRIPTIONS',		'Manage<br/>iCAL Subscriptions');
define( '_CAL_LANG_ADMIN_EXPORT_TO_ICAL',  'Export old style events to ICS File');
