 ...
 *
 * @version     $Id: admin_german.php 880 2007-10-31 19:16:08Z tstahl $
 * @package     Events
...
define( '_CAL_LANG_HIDE_LINKS',			'Verstecke Links mit Javascript' );
define( '_CAL_LANG_HIDE_LINKS_TIP',		'Versteckt den Link vor den meisten Suchmaschinen' );
...
define( '_CAL_LANG_VIEWNAME',		    'Layout ausw&auml;en' );
define( '_CAL_LANG_TIP_VIEWNAME',	    'Layout ausw&auml;en' );
define( '_CAL_LANG_VIEW_DEFAULT',	    'Standard Layout' );
define( '_CAL_LANG_VIEW_ALTERNATIVE',	'Alternatives Layout' );

// RSS config
define( '_CAL_LANG_TAB_RSS',			'XXXXRSS' );
define( '_CAL_LANG_SETT_FOR_RSS',		'XXXXThese settings are only the RSS syndications' );
define( '_CAL_RSS_CACHE',				'XXXXShould RSS results be cached?' );
define( '_CAL_RSS_LIMIT',				'XXXXNumber of Events to show' );
define( '_CAL_RSS_TITLE',				'XXXXRSS Title' );
define( '_CAL_RSS_DESCRIPTION',			'XXXXRSS Description' );
define( '_CAL_RSS_IMAGE',				'XXXXImage to be included in Feed' );
define( '_CAL_RSS_IMAGE_ALT',			'XXXXAlternative Text for image' );
define( '_CAL_RSS_LIMIT_TEXT_LENGTH',	'XXXXLimit Text Length' );
define( '_CAL_RSS_TEXT_LIMIT',			'XXXXText Limit' );
define( '_CAL_RSS_LIVE_BOOMARKS',		'XXXXLive Bookmarks' );
...
define( '_CAL_LANG_TIP_LEV_DAY_RANGE',		'Anzahl der Tage VOR und NACH dem heutigen Tag um weitere Termine anzuzeigen [nur g&uuml;ltig im Modus 1 und 3]');
...
define( '_CAL_LANG_TIP_LEV_HIDE_LINK',		'Versteckt den Link vor den meisten Suchmaschinen');
...
define( '_CAL_LANG_LEV_MAX_DISPLAY_TIP','Maximale Anzahl Termine, die das Modul anzeigt(max 150)' );
...
define( '_CAL_LANG_LEV_REP_EV_ONCE_TIP','Termine mit Wiederholungen werden im Modul nur einmal angezeigt' );
define( '_CAL_LANG_LEV_EV_AS_LINK',		'Termine als Link anzeigen' );
define( '_CAL_LANG_LEV_EV_AS_LINK_TIP',	'Erzeugt die Titel des Temins als Link zur Detailanzeige der Komponente' );
define( '_CAL_LANG_LEV_DISPLAY_YEAR',	'Jahr anzeigen' );
define( '_CAL_LANG_LEV_CSS_DATE_FIELD',	'CSS f&uuml;r Datumsfeld ausschalten' );
define( '_CAL_LANG_LEV_CSS_DATE_FIELD_TIP',	'Erzeugt nicht die Standard CSS Klasse mod_events_latest_date f&uuml;r das Datumsfeld' );
define( '_CAL_LANG_LEV_CSS_TITLE_FIELD','CSS f&uuml;r Titel ausschalten' );
define( '_CAL_LANG_LEV_CSS_TITLE_FIELD_TIP','Erzeugt nicht die Standard CSS Klasse mod_events_latest_content f&uuml;r das Titelfeld' );
define( '_CAL_LANG_LEV_LINKCAL_FIELD',	'Link zur Kalender Komponente');
define( '_CAL_LANG_LEV_LINKCAL_FIELD_TIP', 'Erzeugt einen Link zur Kalenderkomponente. Die aktuellen Kategorien werden als Parameter mit &uuml;bergeben');
define( '_CAL_LANG_LEV_NOLINK',			'Kein Link');
define( '_CAL_LANG_LEV_FIRSTLINE',		'Erste Zeile');
define( '_CAL_LANG_LEV_LASTLINE',		'Letzte Zeile');

define( '_CAL_LANG_LEV_HIDE_LINK',		'Verstecke Titellink mit Javascript');
define( '_CAL_LANG_LEV_CUST_FORM_STRING','Individuelle Formatierung' );
define( '_CAL_LANG_LEV_CUST_FORM_STRING_TIP','Erm&ouml;glicht die Konfiguration der gew&uuml;nschten Event-Felder und die Formatierung der Datumsfelder zur Anzeige durch das Modul. HTML Tags k&ouml;nnen enthalten sein.' );
define( '_CAL_LANG_LEV_AVAIL_FIELDS',	'Verf&uuml;gbare Event Felder');
define( '_CAL_LANG_LEV_FUNC_DATE',		'Datumsformatierung mit date()');
define( '_CAL_LANG_LEV_FUNC_STRFTIME',	'Datumsformatierung mit strftime()');
