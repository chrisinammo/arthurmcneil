<link href="modules/mod_tabarts/style/<?php echo $this->styleCSSfile; ?>.css" rel="stylesheet" type="text/css" />
...
<?php endif; ?>
<script type="text/javascript">
	$Gavick["gk_tabarts<?php echo $this->module_id;?>"] = {
...
<div class="gk_tabarts clearfix" id="<?php echo $this->module_id;?>">
		<?php if($this->styleType == 0) : ?>
			<div class="gk_tabarts_wrap clearfix" style="<?php echo $this->hstyle; ?>">
		<?php endif; ?>	
                ...
                <div class="gk_tabarts_container0 clearfix" style="<?php echo $this->style; ?>">
                        <div class="gk_tabarts_container1 clearfix" style="<?php echo $this->style; ?>">
                                <div class="gk_tabarts_container2 clearfix">
                                        <?php TabArtsHelper::articleRender(); ?>
                                </div>
                        </div>
                </div>
