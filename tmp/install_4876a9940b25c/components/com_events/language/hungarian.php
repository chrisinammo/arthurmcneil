...
// common
define("_CAL_LANG_TIME",				"Idõpont");
define("_CAL_LANG_CLICK_TO_OPEN_EVENT",	"Kattintson ide az esemény megnyitásához");
define("_CAL_LANG_UNPUBLISHED",		"** Visszavonva **");
define("_CAL_LANG_DESCRIPTION",		"Leírás");
define("_CAL_LANG_EMAIL_TO_AUTHOR",	"Email a szerzõnek");
...
define("_CAL_LANG_CLICK_TOSWITCH_NM",	"Ugrás a naptárban ide - következõ hónap");
define("_CAL_LANG_CLICK_TOSWITCH_NY",	"Ugrás a naptárban ide - következõ év");

// navTableNext
define("_CAL_LANG_NAV_TN_FIRST_LIST",	"elsõ lista");
define("_CAL_LANG_NAV_TN_PREV_LIST",	"utolsó lista");
define("_CAL_LANG_NAV_TN_NEXT_LIST",	"következõ lista");
...
define("_CAL_LANG_FIRST_DAY_OF_MULTIEVENT",	"Egy többnapos esemény elsõ napja");
...
DEFINE("_CAL_LANG_ACT_ADDED", "Köszönjük a bejegyzését - Javaslatát rövidesen ellenõrizni fogjuk!"); //NO ACCENT !!
...
DEFINE("_CAL_LANG_NOPERMISSION", "Eme szolgáltatáshoz való hozzáférés az Ön számára nem engedélyezett!"); //NO ACCENT !!
...
DEFINE("_CAL_LANG_NO_EVENTFOR", "Nincs találat a következõ kulcsszóra:");
...
DEFINE("_CAL_LANG_REP_NOEVENTSELECTED", "Kérjük, hogy elõbb válassza ki az eseményt");
...
DEFINE("_CAL_LANG_ADMINPANEL", "Kezelõpanel");
...
DEFINE("_CAL_LANG_REPEAT_DISABLED", "Az esemény ismétlõdése csak akkor alkalmazható, ha a záró dátum régebbi a kezdõ dátumnál.  Változtassa meg a záró dátumot az esemény ismétlõdési részleteinek beállítása elõtt."); // New for 1.4
...
DEFINE("_CAL_LANG_EVENT_URLMAIL_INFO", "URL-cím vagy email cím hozzáadása esetén egyszerûen írja csak be, hogy <u>http://www.enweblapom.hu</u> vagy <u>mailto:en@mail.com</u>");
DEFINE("_CAL_LANG_EVENT_ADRESSE", "Hely");
DEFINE("_CAL_LANG_EVENT_CONTACT", "Kapcsolattartó");
DEFINE("_CAL_LANG_EVENT_EXTRA", "Kiegészítõ információ");
DEFINE("_CAL_LANG_EVENT_AUTHOR_ALIAS", "Szerzõ (álnév)");
DEFINE("_CAL_LANG_EVENT_STARTDATE", "Kezdõ dátum");
DEFINE("_CAL_LANG_EVENT_ENDDATE", "Záró dátum");
DEFINE("_CAL_LANG_EVENT_STARTHOURS", "Kezdõ óra");
DEFINE("_CAL_LANG_EVENT_ENDHOURS", "Záró óra");
DEFINE("_CAL_LANG_EVENT_STARTTIME", "Kezdõ idõpont");
DEFINE("_CAL_LANG_EVENT_ENDTIME", "Záró idõpont");
DEFINE("_CAL_LANG_PUB_INFO", "Közzététel dátuma");
DEFINE("_CAL_LANG_EVENT_REPEATTYPE", "Ismétlõdés tipusa");
DEFINE("_CAL_LANG_EVENT_REPEATDAY", "Ismétlõdés napja");
DEFINE("_CAL_LANG_EVENT_CHOOSE_WEEKDAYS", "A hét napjai");
DEFINE("_CAL_LANG_EVENT_PER", "");
DEFINE("_CAL_LANG_EVENT_WEEKOPT", "Egy hónap hete(i)nek ismétlõdési típusa a hét");

DEFINE("_CAL_LANG_SUBMITPREVIEW", "Elõnézet");
DEFINE("_CAL_LANG_SUBMITCANCEL", "Mégse");
DEFINE("_CAL_LANG_SUBMITSAVE", "Mentés");

DEFINE("_CAL_LANG_E_WARNWEEKS", "Kérjük, hogy válassza ki a hetet.");
DEFINE("_CAL_LANG_E_WARNDAYS", "Kérjük, hogy válassza ki a napot.");
...
DEFINE("_CAL_LANG_WARNACTIVITY", "Írja be a tevékenység\\nleírását ide.");

DEFINE("_CAL_LEGEND_ALL_CATEGORIES", "Minden kategória ...");  // new for 1.4
DEFINE("_CAL_LEGEND_ALL_CATEGORIES_DESC", "Az összes kategóriában lévõ események megjelenítése");  // new for 1.4
...
DEFINE("_CAL_LANG_FORM_HELP_COLOR", <<<END
        <tr>
          ...
          <td>Válassza ki a havi naptár nézetben látható háttérszínt.  Ha kijelöli a Kategória jelölõnégyzetet, akkor ez a szín lesz 
...
DEFINE("_CAL_LANG_FORM_HELP",  <<<END
    	<tr>
          ...
          <td>Válassza ki az esemény kezdõ és záró dátumát.</td>
        </tr>
    	<tr>
          <td align="left" valign="top"><b>Idõpont</b></td>
          <td>Adja meg az esemény idõpontját.  A formátuma <span style='color:blue;font-weight:bold;'>hh:mm {am|pm}</span>.<br/>Az idõpontot 12 vagy órás formátumban is megadhatja.<br/><br/><b><i><span style='color:red;'>(Új)</span></i> Megjegyzés</b>: különleges eset áll fenn az <span style='color:red;font-weight:bold;'>egynapos éjszakai eseményeknél</span>.  Pl.: tegyük fel, hogy egy egynapos esemény 19:00 órakor kezdõdik, és 3:00 órakor fejezõdik be, ilyenkor a kezdõ és a záró dátumnak ugyanannak a dátumnak&nbsp;
		   <b>KELL</b> lennie, és arra a dátumra kell állítania, amelyik megegyezik az éjfél elõtti nappal.</td>
        </tr>
END
);
...
DEFINE("_CAL_LANG_FORM_HELP_EXTENDED",  <<<END
        <tr>
    	  <td align="left" valign="top" nowrap><b>Ismétlõdés típusa</b></td>
  	  	<td colspan="2"></td>
  		</tr>
  		<tr>
	    	...
	    	<table width="100%" border="0" cellspacing="2">
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_bydays">
                  <font color="#000000">Ezt a lehetõséget nem ismétlõdõ, egyszeri vagy többnapos esemény esetén válassza, új esemény elõfordulásával minden napra a kezdõ és a záró dátum idõtartamán belül</font>
                </td>
              </tr>
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_byweeks">
                  <font color="#000000">
                  Ezzel a lehetõséggel az ismétlõdés napjait választhatja ki
                  <table border="0" width="100%" height="100%"><tr><td><b>Nap sorszáma</b> minden 10/../2003 típusú ismétlõdéshez</td></tr><tr><td><b>Nap sorszáma</b> minden hétfõn típusú ismétlõdéshez</td></tr></table>
                  </font>
                </td>
              </tr>
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_byweeks">
                  <font color="#000000">Ezzel a lehetõséggel választhatja ki, hogy a hét mely napjain legyen látható az esemény.</font>
                </td>
              </tr>
              <tr>
                <td width="110" align="left" valign="top" class="frm_td_byweeks">
                  <font color="#000000"><i>Hónap #. hete <br>A fenti 'Hetente egyszer' és 'Hetente többször' lehetõségekhez</i></font></td>
                  <td align="left" valign="top" class="frm_td_byweeks">
                  <font color="#000000">
              ...
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_bymonth">
                  <font color="#000000">
                     Ezzel a lehetõséggek választhatja ki a hónap ismétlõdõ napját
                     <table border="0" width="100%" height="100%"><tr><td><b>Nap sorszáma</b> minden 10/../2003 típusú ismétlõdéshez</td></tr><tr><td><b>Nap sorszáma</b> minden hétfõn típusú ismétlõdéshez</td></tr></table>
		...
		az eseményhez megadott kezdõ és záró dátum közti idõtartamba esik.
                  </font>
                </td>
              </tr>
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_byyear">
                  <font color="#000000">
                  Ezzel a lehetõséggel minden évben egy napot választhat ki
                  <table border="0" width="100%" height="100%"><tr><td><b>Nap sorszáma</b> minden 10/../2003 típusú ismétlõdéshez</td></tr><tr><td><b>Nap sorszáma</b> minden hétfõn típusú ismétlõdéshez</td></tr></table>
                  </font>
                </td>
              </tr>
