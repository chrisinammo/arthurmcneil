 ...
 *
 * @version     $Id: hungariani.php 991 2008-03-10 19:55:48Z tstahl $
 * @package     Events
...
DEFINE("_CAL_LANG_ACT_ADDED", "Köszönjük a bejegyzésedet - Javaslatodat rövidesen ellenõrizni fogjuk!"); //NO ACCENT !!
...
DEFINE("_CAL_LANG_REP_NOEVENTSELECTED", "Kérjük, hogy elõbb válaszd ki az eseményt");
...
DEFINE("_CAL_LANG_REPEAT_DISABLED", "Az esemény ismétlõdése csak akkor alkalmazható, ha a záró dátum régebbi a kezdõ dátumnál.  Változtasd meg a záró dátumot az esemény ismétlõdési részleteinek beállítása elõtt."); // New for 1.4
...
DEFINE("_CAL_LANG_EVENT_URLMAIL_INFO", "URL-cím vagy email cím hozzáadása esetén egyszerûen írd csak be, hogy <u>http://www.enweblapom.hu</u> vagy <u>mailto:en@mail.com</u>");
...
DEFINE("_CAL_LANG_FORM_HELP_COLOR", <<<END
        <tr>
          ...
          <td>Válaszd ki a havi naptár nézetben látható háttérszínt.  Ha kijelölöd a Kategória jelölõnégyzetet, akkor ez a szín lesz 
...
DEFINE("_CAL_LANG_FORM_HELP",  <<<END
    	...
    	<tr>
          ...
          <td>Add meg az esemény idõpontját.  A formátuma <span style='color:blue;font-weight:bold;'>hh:mm {am|pm}</span>.<br/>Az idõpontot 12 vagy órás formátumban is megadhatod.<br/><br/><b><i><span style='color:red;'>(Új)</span></i> Megjegyzés</b>: különleges eset áll fenn az <span style='color:red;font-weight:bold;'>egynapos éjszakai eseményeknél</span>.  Pl.: tegyük fel, hogy egy egynapos esemény 19:00 órakor kezdõdik, és 3:00 órakor fejezõdik be, ilyenkor a kezdõ és a záró dátumnak ugyanannak a dátumnak&nbsp;
		   <b>KELL</b> lennie, és arra a dátumra kell állítanod, amelyik megegyezik az éjfél elõtti nappal.</td>
        </tr>
END
);
	    	...
	    	<table width="100%" border="0" cellspacing="2">
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_bydays">
                  <font color="#000000">Ezt a lehetõséget nem ismétlõdõ, egyszeri vagy többnapos esemény esetén válaszd, új esemény elõfordulásával minden napra a kezdõ és a záró dátum idõtartamán belül</font>
                </td>
              </tr>
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_byweeks">
                  <font color="#000000">
                  Ezzel a lehetõséggel az ismétlõdés napjait választhatod ki
              ...
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_byweeks">
                  <font color="#000000">Ezzel a lehetõséggel választhatod ki, hogy a hét mely napjain legyen látható az esemény.</font>
                </td>
              </tr>
              <tr>
                <td width="110" align="left" valign="top" class="frm_td_byweeks">
              ...
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_bymonth">
                  <font color="#000000">
                     Ezzel a lehetõséggek választhatod ki a hónap ismétlõdõ napját
                     <table border="0" width="100%" height="100%"><tr><td><b>Nap sorszáma</b> minden 10/../2003 típusú ismétlõdéshez</td></tr><tr><td><b>Nap sorszáma</b> minden hétfõn típusú ismétlõdéshez</td></tr></table>
		...
		az eseményhez megadott kezdõ és záró dátum közti idõtartamba esik.
              ...
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_byyear">
                  <font color="#000000">
                  Ezzel a lehetõséggel minden évben egy napot választhatsz ki
                  <table border="0" width="100%" height="100%"><tr><td><b>Nap sorszáma</b> minden 10/../2003 típusú ismétlõdéshez</td></tr><tr><td><b>Nap sorszáma</b> minden hétfõn típusú ismétlõdéshez</td></tr></table>
                  </font>
                </td>
              </tr>
