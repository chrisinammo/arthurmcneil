 ...
 *
 * @version     $Id: hungarian-utf8.php 991 2008-03-10 19:55:48Z tstahl $
 * @package     Events
...
DEFINE("_CAL_LANG_ACT_ADDED", "Köszönjük a bejegyzését - Javaslatát rövidesen ellenőrizni fogjuk!"); //NO ACCENT !!
...
DEFINE("_CAL_LANG_REP_NOEVENTSELECTED", "Kérjük, hogy előbb válassza ki az eseményt");
...
DEFINE("_CAL_LANG_REPEAT_DISABLED", "Az esemény ismétlődése csak akkor alkalmazható, ha a záró dátum régebbi a kezdő dátumnál.  Változtassa meg a záró dátumot az esemény ismétlődési részleteinek beállítása előtt."); // New for 1.4
...
DEFINE("_CAL_LANG_EVENT_URLMAIL_INFO", "URL-cím vagy email cím hozzáadása esetén egyszerűen írja csak be, hogy <u>http://www.enweblapom.hu</u> vagy <u>mailto:en@mail.com</u>");
...
DEFINE("_CAL_LANG_FORM_HELP_COLOR", <<<END
        <tr>
          ...
          <td>Válassza ki a havi naptár nézetben látható háttérszínt.  Ha kijelöli a Kategória jelölőnégyzetet, akkor ez a szín lesz 
...
DEFINE("_CAL_LANG_FORM_HELP",  <<<END
    	...
    	<tr>
          ...
          <td>Adja meg az esemény időpontját.  A formátuma <span style='color:blue;font-weight:bold;'>hh:mm {am|pm}</span>.<br/>Az időpontot 12 vagy órás formátumban is megadhatja.<br/><br/><b><i><span style='color:red;'>(Új)</span></i> Megjegyzés</b>: különleges eset áll fenn az <span style='color:red;font-weight:bold;'>egynapos éjszakai eseményeknél</span>.  Pl.: tegyük fel, hogy egy egynapos esemény 19:00 órakor kezdődik, és 3:00 órakor fejeződik be, ilyenkor a kezdő és a záró dátumnak ugyanannak a dátumnak&nbsp;
		   <b>KELL</b> lennie, és arra a dátumra kell állítania, amelyik megegyezik az éjfél előtti nappal.</td>
        </tr>
END
);
	    	...
	    	<table width="100%" border="0" cellspacing="2">
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_bydays">
                  <font color="#000000">Ezt a lehetőséget nem ismétlődő, egyszeri vagy többnapos esemény esetén válassza, új esemény előfordulásával minden napra a kezdő és a záró dátum időtartamán belül</font>
                </td>
              </tr>
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_byweeks">
                  <font color="#000000">
                  Ezzel a lehetőséggel az ismétlődés napjait választhatja ki
              ...
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_byweeks">
                  <font color="#000000">Ezzel a lehetőséggel választhatja ki, hogy a hét mely napjain legyen látható az esemény.</font>
                </td>
              </tr>
              <tr>
                <td width="110" align="left" valign="top" class="frm_td_byweeks">
              ...
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_bymonth">
                  <font color="#000000">
                     Ezzel a lehetőséggek választhatja ki a hónap ismétlődő napját
                     <table border="0" width="100%" height="100%"><tr><td><b>Nap sorszáma</b> minden 10/../2003 típusú ismétlődéshez</td></tr><tr><td><b>Nap sorszáma</b> minden hétfőn típusú ismétlődéshez</td></tr></table>
		...
		az eseményhez megadott kezdő és záró dátum közti időtartamba esik.
              ...
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_byyear">
                  <font color="#000000">
                  Ezzel a lehetőséggel minden évben egy napot választhat ki
                  <table border="0" width="100%" height="100%"><tr><td><b>Nap sorszáma</b> minden 10/../2003 típusú ismétlődéshez</td></tr><tr><td><b>Nap sorszáma</b> minden hétfőn típusú ismétlődéshez</td></tr></table>
                  </font>
                </td>
              </tr>
