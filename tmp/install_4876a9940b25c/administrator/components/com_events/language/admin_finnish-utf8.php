 ...
 *
 * @version     $Id: admin_finnish-utf8.php 991 2008-03-10 19:55:48Z tstahl $
 * @package     Events
...
define( '_CAL_LANG_DISPLAY',			'Näytä' );
...
define( '_CAL_LANG_MSG_CHMOD_CONFIG',	'Sinun pitää antaa asetustiedostoon kirjoitusoikeudet kaikille (chmod 0777), jotta se voidaan p&auml;ivitt&auml;&auml;' );
define( '_CAL_LANG_MSG_CHMOD_CSS',		'Sinun pitää antaa CSS tiedostoon kirjoitusoikeudet kaikille (chmod 0777), jotta se voidaan p&auml;ivitt&auml;&auml;' );
...
define( '_CAL_LANG_TIP_LEV_DAY_RANGE',		'Tapahtuman etäisyys (päivinä) nykyisestä päivästä, jolloin tapahtuma listataan (vain moodit 1 ja 3)' );
...
define( '_CAL_LANG_TIP_LEV_HIDE_LINK',		'Jos tämä on KYLL&Auml;, otsikon linkki asetetaan dynaamisesti javascriptillä &lt;b&gt;onclick&lt;/b&gt;-tapahtumassa. T&auml;m&auml; est&auml;&auml; hakukoneita seuraamasta linkki&auml;');
...
define( '_CAL_LANG_DLM_ALWYS_IF_EVENTS','AINA - jos se sis&auml;lt&auml;&auml; tapahtumia' );
	// stop day
define( '_CAL_LANG_DLM_STOP_DAY',		'Päivä, jolloin lakataan näyttämästä viime kuukautta' );
	// display next month
