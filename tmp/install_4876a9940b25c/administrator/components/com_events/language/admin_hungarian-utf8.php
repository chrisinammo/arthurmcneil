 ...
 *
 * @version     $Id: admin_hungarian-utf8.php 991 2008-03-10 19:55:48Z tstahl $
 * @package     Events
...
define( '_CAL_LANG_CLICK_TO_EDIT',		'Kattintson ide a szerkesztéshez' );
...
define( '_CAL_LANG_PREVIEW',			'Előnézet' );
...
define( '_CAL_LANG_REPEAT',				'Ismétlődés' );
define( '_CAL_LANG_TIME_SHEET',			'Időrend' );
define( '_CAL_CLICK_TO_CHANGE_STATUS',	'Kattintson az ikonra az állapot átváltásához' );
define( '_CAL_LANG_PUB_BUT_COMING',		'Közzétéve, és <u>esedékes</u>' );
define( '_CAL_LANG_PUB_ACTUAL',			'Közzétéve, és a <u>jelenlegi</u>' );
define( '_CAL_LANG_PUB_FINISHED',		'Közzétéve, de <u>befejeződött</u>' );
define( '_CAL_LANG_EDIT_EVENT',			'Esemény módosítása' );
define( '_CAL_LANG_ADD_EVENT',			'Új esemény' );
define( '_CAL_LANG_REQUIRED',			'kötelező' );
define( '_CAL_LANG_IMG_FOLDER',			'Alkönyvtár' );
define( '_CAL_LANG_IMAGES',				'Galériaképek' );
define( '_CAL_LANG_AVAL_IMAGES',		'Létező képek' );
...
define( '_CAL_LANG_ALT_TXT',			'Helyettesítő szöveg' );
...
define( '_CAL_LANG_ADD_INFO',			'Kiegészítő információ' );
...
define( '_CAL_LANG_MAX_DISPLAY',		'Események megjelenítendő száma' );
define( '_CAL_LANG_DIS_STARTTIME',		'Kezdő időpont megjelenítése' );
...
define( '_CAL_LANG_SETT_FOR_CAL_MOD',	'Az alábbi beállítások csak a kiegészítő naptármodulra vonatkoznak' );
define( '_CAL_LANG_SETT_FOR_MOD_LATEST','Az alábbi beállítások csak az [ Új események ] kiegészítő modulra vonatkoznak' );
define( '_CAL_LANG_ICONIC_NAVBAR'		,'Új navigációs ikonsáv használata'); // 1.4
define( '_CAL_LANG_CHECK_VERSION'		,"Új verzió ellenőrzése"); // 1.4

// errors
define( '_CAL_LANG_ERR_CAT_MUST_HAVE_NAME',	'Adjon nevet a kategóriának!' );
...
define( '_CAL_LANG_TIT_PENDING',		'Függőben' );

// msgs
define( '_CAL_LANG_MSG_CAT_IS_EDITED',	'A kategóriát [ %s ] épp egy másik adminisztrátor szerkeszti' ); // %s = $row->title
define( '_CAL_LANG_MSG_OP_FAILED',		'Sikertelen művelet: nem nyitható meg a(z) [ %s ]' ); // %s = $filename
define( '_CAL_LANG_MSG_CHANGE_EMAIL',	'Előbb változtassa meg a JEVENTS beállításaiban az EMAIL címet' );
define( '_CAL_LANG_MSG_ADD_CAT_BEFORE',	'Előbb adjon hozzá egy kategóriát ehhez a szekcióhoz' );
define( '_CAL_LANG_MSG_CONFIG_SAVED',	'A beállítások mentése sikerült' );
define( '_CAL_LANG_MSG_WARNING',		'Figyelmeztetés...' );
define( '_CAL_LANG_MSG_CHMOD_CONFIG',	'A konfigurációs fájl CHMOD értékét állítsa 0777-re, hogy a beállítások módosíthatók legyenek' );
define( '_CAL_LANG_MSG_CHMOD_CSS',		'A CSS fájl CHMOD értékét állítsa 0777-re, hogy a beállítások módosíthatók legyenek' );
define( '_CAL_LANG_MSG_MOD_NOT_INSTALLED','A naptármodult még nem telepítette' );
define( '_CAL_LANG_MSG_NO_MOD_LATEST',	'Az [ Új események ] modult még nem telepítette' );

// tips
define( '_CAL_LANG_TIP_ACCESS',			'Kinek engedélyezi az új események bejegyzését' );
define( '_CAL_LANG_TIP_FRONT_PUB',		'A közzétevők, a kezelők és az adminisztrátorok tehetik közzé a bejegyzéseket a látogatói oldalról' );
define( '_CAL_LANG_TIP_NR_OF_LIST',		'A heti, havi vagy éves nézetben oldalanként kilistázandó események száma' );
define( '_CAL_LANG_TIP_FE_SIMPLE_FORM',	'Az egyszerű (pl. nincsenek ismétlődési típusok) eseménybejegyzési űrlapot használja a látogatói oldalon' );
define( '_CAL_LANG_TIP_DEF_EC_HIDE_FORCE',	'<b>Eseményspecifikus színek használata engedélyezett</b><br/>A látogatói oldal és a kiszolgálói oldal szerkesztői eseményspecifikus színeket használhatnak<br/><b>Eseményszínek csak a kiszolgáló oldali szerkesztésben</b><br/>Csak a kiszolgálói oldal szerkesztői határozhatnak meg eseményspecifikus színeket<br/><b>Mindig a kategóriaszíneket használja</b><br/>A szerkesztők nem használhatnak eseményspecifikus színeket, és bármilyen eseményspecifikus szín, melyet eme beállítás használata előtt definiáltak, mellőzésre kerül, a kategóriaszín látható helyette' );
define( '_CAL_LANG_TIP_DLM_STOP_DAY',		'A jelenlegi hónap napjainak száma az előző hónap megjelenítéséhez' );
define( '_CAL_LANG_TIP_DNM_START_DAY',		'A jelenlegi hónapból hátralévő napok száma a következő hónap megjelenítésének az indításához' );
define( '_CAL_LANG_TIP_LEV_DAY_RANGE',		'A mai naphoz viszonyított időtartam napban az események megjelenítéséhez (csak az 1. és a 3. módban)' );
define( '_CAL_LANG_TIP_LEV_DISPLAY_YEAR',	'Az évszám kijelzése az esemény dátumában (csak az alapértelmezett formátumban)' );
define( '_CAL_LANG_TIP_BTN_DEF_CONFIG',		'Betölti az alapértelmezés szerinti értékeket [abban az esetben, ha valamit elrontott]' );
define( '_CAL_LANG_TIP_LEV_DISPLAY_MODE',	'0 (alapértelmezett) a jelenlegi hét legközelebbi eseményeit jeleníti meg, a következő hetet csak az eseményes legnagyobb számáig<br />1 ugyanaz, mint a [ mode = 0 ], azzal a kivétellel, hogy a jelenlegi hét elavult eseményei is láthatók lesznek, ha a jövőbeli események száma kisebb az események maximális számánál<br />2 a [ + napok ] időköz a mai naphoz viszonyított legközelebbi eseményeit jeleníti meg a $maxEvents számáig<br />3 ugyanaz, mint a 2. mód, azzal a kivétellel, hogy a maximális eseményeknél kevesebb van az időtartamban, majd a mai naphoz viszonyítva  megjeleníti az elavult eseményeket a [ - napok ] tartományban<br />4 a jelenlegi hónap legközelebbi eseményeit jeleníti meg a mai naphoz viszonyítva az oldalankénti számban' );
...
define( '_CAL_LANG_TIP_LEV_HIDE_LINK',		'Ha az IGEN-t választja, akkor a JavaScript &lt;b&gt;onclick&lt;/b&gt; esemény dinamikusan végzi a címcsatolást. Ezzel megakadályozhatja, hogy a keresőmotorok követhessék a hivatkozást');
define( '_CAL_LANG_TIP_MAX_DISPLAY',		'A <strong>szövegként</strong> megjelenítendő események száma naponta havi nézetben<br />Ha sok eseménye van naponta, megjelenítésük rombolhatja az elrendezést.<br />Itt adhatja meg, hogy hány esemény legyen látható szövegként, ha túl sok van, akkor ikonnal történik a megjelenítésük (a buborékra nincs hatással)<br /><strong>Tipp</strong>: Az érték 0-ra [nullára] állítása az összes esemény ikonnal történő megjelenítésére kényszerít' );
define( '_CAL_LANG_TIP_DIS_STARTTIME',		'Legyen-e látható a kezdő időpont [ havi nézetben ]' );
	// tooltips
...
define( '_CAL_LANG_TIP_TT_POSY',			'A buborék függőleges elhelyezése történhet alá vagy fölé' );
...
define( '_CAL_LANG_SEL_ACCESS_ALL_AUTHORS',	'Szerzők és fölötte' );
define( '_CAL_LANG_SEL_ACCESS_ALL_EDITORS',	'Szerkesztők és fölötte' );
define( '_CAL_LANG_SEL_ACCESS_ALL_PUBLISHERS',	'Közzétevők és fölötte' );
define( '_CAL_LANG_SEL_ACCESS_ALL_MANAGERS',	'Kezelők és fölötte' );
define( '_CAL_LANG_SEL_ACCESS_ALL_ADMIN',	'Csak az adminisztrátorok és a főadminisztrátorok' );
	// first day
define( '_CAL_LANG_FIRST_DAY',			'A hét első napja' );
define( '_CAL_LANG_SUNDAY_FIRST',		'Vasárnap' );
define( '_CAL_LANG_MONDAY_FIRST',		'Hétfő' );
...
define( '_CAL_LANG_VIEW_REPEAT_TIME',	'Az ismétlődés és az időpont megjelenítése' );
define( '_CAL_LANG_VIEW_REPEAT_YEAR_LIST',	'Az összes ismétlődő esemény megjelenítése az éves listában' );
define( '_CAL_LANG_SHOW_CATS',			'A "Kategóriánként" elrejtése (csak akkor, ha az események jelmagyarázata modul látható)' );
define( '_CAL_LANG_SHOW_COPYRIGHT',		'A szerzői jogi információt megjelenítő lábjegyzet megjelenítése');
	// date format
...
define( '_CAL_LANG_TIME_FORMAT_12',		'Az idő kijelzése 12 órás formátumban' );
	// nav bar
...
define( '_CAL_LANG_NAV_BAR_YELLOW',		'Sárga' );
	...
	// start page
define( '_CAL_LANG_START_PAGE',			'Kezdő oldal' );
...
define( '_CAL_LANG_FE_SIMPLE_FORM',		'Egyszerű mód használata' );
	// event color
define( '_CAL_LANG_DEF_EVENT_COLOR',	'Alapértelmezett eseményszín' );
define( '_CAL_LANG_DEF_EC_RANDOM',		'Véletlenszerű' );
...
// calendar module
	// display last month
define( '_CAL_LANG_DISPLAY_LAST_MONTH',	'Az előző hónap megjelenítése' );
...
define( '_CAL_LANG_DLM_STOP_DAY',		'A jelenlegi hónap napjainak száma a leállításhoz' );
	// display next month
define( '_CAL_LANG_DISPLAY_NEXT_MONTH',	'A következő hónap megjelenítése' );
define( '_CAL_LANG_DNM_YES_START_DAY',	'IGEN - az első nappal' );
define( '_CAL_LANG_DNM_YES_EVENT_SDAY', 'IGEN - ha vannak események ÉS az első nappal' );
define( '_CAL_LANG_DNM_ALWYS_IF_EVENTS','MINDIG - ha vannak események' );
	// start day
define( '_CAL_LANG_DNM_START_DAY',		'A jelenlegi hónapból hátralévő napok száma a kezdéshez' );

// latest events module
define( '_CAL_LANG_LEV_MAX_DISPLAY',	'A megjelenítendő események száma' );
define( '_CAL_LANG_LEV_DISPLAY_MODE',	'Megjelenítési mód' );
define( '_CAL_LANG_LEV_DAY_RANGE',		'Napok száma előtte-utána' );
define( '_CAL_LANG_LEV_REP_EV_ONCE',	'Egy ismétlődő esemény megjelenítése csak egyszer' );
...
define( '_CAL_LANG_LEV_CSS_DATE_FIELD',	'Az alapértelmezett CSS dátummező stílusának letiltása' );
define( '_CAL_LANG_LEV_CSS_TITLE_FIELD','Az alapértelmezett CSS címmező stílusának letiltása' );
...
define( '_CAL_LANG_INSTAL_ERROR',		'A következő hibák merültek föl' );
...
DEFINE("_CAL_LANG_EVENT_ALLDAY","Egész napos vagy meghatározatlan időtartamú esemény");  // new for 1.4
