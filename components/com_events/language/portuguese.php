...
define("_CAL_LANG_KEYWORD_NOT_VALID",	"Palavra chave não é válida");
...
define("_CAL_LANG_CLICK_TOSWITCH_DAY",	"Ir para o  Calendário -  dia actual");
define("_CAL_LANG_CLICK_TOSWITCH_MON",	"Ir para o  Calendário -  mês actual");
define("_CAL_LANG_CLICK_TOSWITCH_YEAR",	"Ir para o  Calendário -  ano corrente");
define("_CAL_LANG_CLICK_TOSWITCH_PY",	"Ir para o  Calendário -  dia anterior");
define("_CAL_LANG_CLICK_TOSWITCH_PM",	"Ir para o  Calendário -  mês anterior");
define("_CAL_LANG_CLICK_TOSWITCH_NM",	"Ir para o  Calendário -  próximo mês");
define("_CAL_LANG_CLICK_TOSWITCH_NY",	"Ir para o  Calendário -  próximo ano");
...
define("_CAL_LANG_LAST_DAY_OF_MULTIEVENT",		"Último dia de evento multidias");
...
DEFINE("_CAL_LANG_JUMPTO", "Saltar para o mês específico");  // New 1.4
...
DEFINE("_CAL_LANG_REPEAT_DISABLED", "Repetição de eventos só é autorizada se a data de fim for depois da data de Ínicio.  Mude a data de Fim antes de configurar detalhes de repetição de evento ."); // New for 1.4
