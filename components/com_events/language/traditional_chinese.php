 ...
 * @version     $Id: traditional_chinese.php 880 2007-10-31 19:16:08Z tstahl $
 * @package     Events
...
if (floatval($_VERSION->getShortVersion())>=1.5){
	DEFINE("_E_WARNTITLE", "缺少了標題");
	DEFINE("_E_WARNCAT", "缺少了分類");
	DEFINE("_E_STATE", "狀態");
	DEFINE("_E_HITS", "點擊");
	DEFINE("_E_CREATED", "已建立");
	DEFINE("_E_LAST_MOD", "最後修改");
