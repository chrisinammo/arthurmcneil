 ...
 *
 * @version     $Id: english.php 917 2008-01-03 13:44:27Z geraint $
 * @package     Events
...
// new 1.5.0
define("_CAL_LANG_RSSLINK_TIP", "Include link to RSS feed in module");
define("_CAL_LANG_RSSLINK_FIELD","Include link to RSS feed in module");
...
define ("_CAL_LANG_EVENT_CHOOSE_ICAL",	"Please select a calendar");
...
DEFINE("_CAL_LANG_EVERY_N_DAYS", "Every %s days"); //1.5
DEFINE("_CAL_LANG_EACHWEEK", "Every week");
DEFINE("_CAL_LANG_EVERY_N_WEEKS", "Every %s weeks"); //1.5
...
DEFINE("_CAL_LANG_EVERY_N_MONTHS", "Every %s months"); //1.5
DEFINE("_CAL_LANG_EACHYEAR", "Every year");
DEFINE("_CAL_LANG_EVERY_N_YEARS", "Every %s years"); //1.5
...
DEFINE("_CAL_LANG_UNTIL", "until"); //1.5
DEFINE("_CAL_LANG_COUNTREPEATS", "for total of %s repetitions"); //1.5
// Repeat days
DEFINE("_CAL_LANG_BYDAYNUMBER", "By day number");

// Repeat Exception
DEFINE("_CAL_LANG_REPEATEXCEPTION", "This repeat is an exception to the normal repeat pattern");
...
DEFINE("_CAL_LANG_WARNACTIVITY", "Some sort of Activity description must be entered.");
