 ...
 *
 * @version     $Id: germani.php 880 2007-10-31 19:16:08Z tstahl $
 * @package     Events
...
define("_CAL_LANG_REPEAT_GRAMMAR",	"2"); // in repeat summary 1 = follow English word orde, 2= follow German word orderr

// used for ical code from 1.5 onwards
define ("_CAL_LANG_EVENT_CHOOSE_ICAL",	"Bitte Kalender ausw&auml;hlen");
...
define("_CAL_LANG_CLICK_TOCOMPONENT",	"Zum Kalender");
...
DEFINE("_CAL_LANG_EVERY_N_DAYS", "Alle %s Tage"); //1.5
DEFINE("_CAL_LANG_EACHWEEK", "W&ouml;chentlich");
DEFINE("_CAL_LANG_EVERY_N_WEEKS", "Alle %s Wochen"); //1.5
...
DEFINE("_CAL_LANG_EVERY_N_MONTHS", "Alle %s Monate"); //1.5
DEFINE("_CAL_LANG_EACHYEAR", "J&auml;hrlich");
DEFINE("_CAL_LANG_EVERY_N_YEARS", "Alle %s Jahre"); //1.5
...
DEFINE("_CAL_LANG_UNTIL", "bis"); //1.5
...
DEFINE("_CAL_LANG_ACT_PUBLISHED", "Dieser Termin wurde ver&ouml;ffentlicht.");  //NEW 1.4
...
DEFINE("_CAL_LANG_JUMPTO", "Gehe zu Monat");  // New 1.4
...
DEFINE("_CAL_LANG_FORM_HELP_COLOR", <<<END
        <tr>
          ...
          <td><p>W&auml;hle die Hintergrundfarbe für die Kalenderansicht.</p><p>Wenn die Option Kategoriefarbe ausgew&auml;hlt ist,
...
DEFINE("_CAL_LANG_FORM_HELP",  <<<END
    	<tr>
          ...
          <td>W&auml;hle Startdatum und Ende des Termins</td>
        </tr>
    	<tr>
          <td align="left" valign="top"><b>Zeit</b></td>
          <td>Trage den Beginn des Termines ein. Das Format kann so <span style='font-weight:bold;'>hh:mm</span> als 24h Format
              oder <span style='font-weight:bold;'>hh:mm am/pm</span> als 12h-Format eingegeben werden.
<br/><b><i><span style='color:red;'>(Neu)</span>
</i> Beachte</b> den Sonderfall eines <span style='color:red;font-weight:bold;'>eint&auml;gigen Abendtermines</span>. Wenn zum Beispiel eine Feier um 19:00 Uhr beginnt und gegen 3:00 in der Nacht endet, <b>MUSS</b> das gleiche Datum f&uuml;r Beginn und Ende verwendet werden.</td>
        </tr>
END
);
	    	...
	    	<table width="100%" border="0" cellspacing="2">
              <tr>
                ...
                <td align="left" valign="top" class="frm_td_bydays">
                  <font color="#000000">W&auml;hle diese Option f&uuml;r einen eint&auml;gigen oder mehrt&auml;gigen Termin, wenn jeder Tag zwischen Beginn und Ende als Termin angezeigt werden soll.</font>
                </td>
              </tr>
              <tr>
