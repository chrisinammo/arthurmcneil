...
$lang_info = array (
	'name' => 'German'
	,'nativename' => 'Deutsch' // Sprache name in native language. E.g: 'Français' for 'French'
...
$lang_system = array (
  ...
  ,'page_requires_login' => 'Sie m&#252;ssen sich einloggen um auf diese Seite zuzugreifen.'
  ...
  ,'no_table' => 'Die\'%s\' Tabelle ist nicht existent !'
  ,'no_anonymous_group' => 'Die Tabelle  %s enth&#228;lt nicht die \'Anonymous\' Gruppe !'
  ,'calendar_locked' => 'Der Servive ist zur Zeit nicht erreichbar'
...
// Mail messages
	,'new_event_subject' => 'Eine neue Veranstaltung um %s wurde eingetragen'
...
Folgender Termin wurde gerade im {CALENDAR_NAME} eingetragen.

Titel: "{TITLE}"
Datum: "{DATE}"
Dauer: "{DURATION}"

&#220;ber den eingef&#252;gten Link k&#246;nnen sie auf den Kalender zugreifen.
...
Herzlichen Dank, dass Sie sich bei uns angemeldet haben,
...
// General Einstellungen
	...
	,'cookie_name' => 'Name der Cookies die vom Script benutzt werden.'
	,'cookie_path' => 'Pfad der Cookies die vom Script benutzt werden.'
...
if (!defined('_EXTCAL_THEMES_INSTALL_HEADING'))
{
	...
	DEFINE('_EXTCAL_LANG_BACK', 'Zurück zum Sprachen Manager');
	//
